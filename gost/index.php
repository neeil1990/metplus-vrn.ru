...
$APPLICATION->SetPageProperty("description", "ГОСТы и ТУ металлопроката | Металлинвест | Скачать документы");
$APPLICATION->SetPageProperty("title", "ГОСТЫ И ТУ металлопроката | Металлинвест");
