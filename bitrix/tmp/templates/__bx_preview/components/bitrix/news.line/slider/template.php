...
?>
<div class="main-section slider-section" <? if($arResult["ITEMS"][0]['PREVIEW_PICTURE']['SRC']): ?>style="background: url(<?=$arResult["ITEMS"][0]['PREVIEW_PICTURE']['SRC']?>) no-repeat center top;"<? endif;?>>
    <div class="container">
					...
					<div class="ads-block">
						<?
							$APPLICATION->IncludeComponent("prime:ads.btn", "", [
								"SHOW" => $arItem["PROPERTIES"]["ADS"]["VALUE_XML_ID"],
