...
final class ModuleCommand extends Command
{
	...
	public function __construct(?string $pathToModulesFolder = null)
	{
		$this->service = new ModuleService(
			$pathToModulesFolder ?? Loader::getLocal('modules')
		);
	...
	protected function configure(): void
	{
		$this
			...
			->addOption('version', null, InputOption::VALUE_REQUIRED, 'Module version', default: '1.0.0')
		;
	}
	...
	protected function execute(InputInterface $input, OutputInterface $output): int
	{
		$dto = new GenerateDto(
			...
			version: $this->askOrGetOption('version', $input, $output),
