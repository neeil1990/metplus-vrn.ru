...
$MESS["IM_CONTENT_TASK_START_FEATURE_LIST_TITLE"] = "Битрикс24 Задачи AI";
$MESS["IM_CONTENT_TASK_START_FEATURE_LIST_BLOCK_TITLE_1"] = "Аудио Задачи AI — слова превращаются в действия";
$MESS["IM_CONTENT_TASK_START_FEATURE_LIST_BLOCK_SUBTITLE_1"] = "Отправьте голосовое сообщение в чат — AI сам поймёт, о чём идёт речь, создаст задачу, добавит описание и чек-лист, назначит исполнителя и срок";
$MESS["IM_CONTENT_TASK_START_FEATURE_LIST_BLOCK_TITLE_2"] = "Задачи можно листать как сообщения в мессенджере";
...
$MESS["IM_CONTENT_COPILOT_EMPTY_STATE_MESSAGE_MSGVER_1"] = "Я — BitrixGPT, искусственный интеллект.#BR#Готов обсудить с вами идеи,#BR#написать текст или поправить ваш.#BR##BR#Выберите для меня роль, чтобы поговорить#BR#со мной как с экспертом в любой области";
...
$MESS["IM_CONTENT_COPILOT_ADD_TO_CHAT_HINT_TITLE"] = "Добавьте участников в чат с BitrixGPT";
$MESS["IM_CONTENT_COPILOT_ADD_TO_CHAT_HINT_DESCRIPTION"] = "Так вы сможете все вместе задавать ему вопросы и обсуждать идеи. Ответы BitrixGPT увидят все участники чата";
