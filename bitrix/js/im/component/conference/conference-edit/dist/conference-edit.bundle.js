	  ...
	  component: {
	    ...
	    computed: {
	      ...
	      formattedInvitation: function formattedInvitation() {
	        ...
	        return this.invitation.value.replace(/#CREATOR#/gm, main_core.Text.encode(this.chatHost.FULL_NAME)).replace(/#TITLE#/gm, "\"".concat(main_core.Text.encode(title), "\"")).replace(/#LINK#/gm, "<a href=\"".concat(this.publicLink, "\" target=\"_blank\" class=\"im-conference-create-invitation-content-text-link\">").concat(this.publicLink, "</a>"));
	      },
	      localize: function localize() {
	        return BX.message;
	      }
