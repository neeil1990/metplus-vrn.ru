...
(
	...
	KEY `IX_B_IM_LINK_URL_6` (`CHAT_ID`, `MESSAGE_ID`)
);
...
(
	...
	KEY `IX_B_IM_REACTION_4` (`CHAT_ID`)
);
...
CREATE TABLE `b_im_file_param`
(
	`ID` INT(18) NOT NULL AUTO_INCREMENT,
	`DISK_FILE_ID` INT(18) NOT NULL,
	`PARAM_NAME` VARCHAR(100) NOT NULL,
	`PARAM_VALUE` VARCHAR(100) NULL,
	PRIMARY KEY (`ID`),
	UNIQUE INDEX `UIX_B_IM_FILE_PARAM_1` (`DISK_FILE_ID`, `PARAM_NAME`)
);

CREATE TABLE `b_im_file_transcription`
(
	`ID` INT NOT NULL AUTO_INCREMENT,
	`FILE_ID` INT NOT NULL,
	`TEXT` TEXT NULL,
	PRIMARY KEY (`ID`),
	UNIQUE INDEX `UIX_B_IM_FILE_TRANSCRIPTION_1` (`FILE_ID`)
);

CREATE TABLE `b_im_ai_transcribe_queue`
(
	`ID` INT NOT NULL AUTO_INCREMENT,
	`FILE_ID` INT NOT NULL,
	`CHAT_ID` INT NOT NULL,
	PRIMARY KEY (`ID`),
	UNIQUE INDEX `UIX_B_IM_AI_TRANSCRIBE_QUEUE_1` (`FILE_ID`, `CHAT_ID`)
);

CREATE TABLE `b_im_sticker_recent`
(
	`ID` INT NOT NULL AUTO_INCREMENT,
	`USER_ID` INT NOT NULL,
	...
	`DATE_CREATE` DATETIME NOT NULL,
	PRIMARY KEY (`ID`),
	UNIQUE INDEX `UIX_B_IM_STICKER_RECENT_1` (`USER_ID`, `STICKER_ID`, `PACK_ID`, `PACK_TYPE`),
	KEY `IX_B_IM_STICKER_RECENT_1` (`USER_ID`, `DATE_CREATE`)
);
