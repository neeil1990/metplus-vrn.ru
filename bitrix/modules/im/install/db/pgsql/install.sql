...
CREATE INDEX ix_b_im_link_url_chat_id_message_id ON b_im_link_url (chat_id, message_id);
...
CREATE INDEX ix_b_im_reaction_chat_id ON b_im_reaction (chat_id);
...
CREATE UNIQUE INDEX ux_b_im_file_param_disk_file_id_param_name ON b_im_file_param (disk_file_id, param_name);
...
CREATE UNIQUE INDEX ux_b_im_file_transcription_file_id ON b_im_file_transcription (file_id);
...
CREATE UNIQUE INDEX ux_b_im_ai_transcribe_queue_file_id_chat_id ON b_im_ai_transcribe_queue (file_id, chat_id);
...
CREATE UNIQUE INDEX ux_b_im_sticker_recent_user_id_sticker_id_pack_id_pack_type ON b_im_sticker_recent (user_id, sticker_id, pack_id, pack_type);
CREATE INDEX ix_b_im_sticker_recent_user_id_date_create ON b_im_sticker_recent (user_id, date_create);
