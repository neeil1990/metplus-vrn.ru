...
/**
	 ...
	 * @subpackage im
	 * @copyright 2001-2020 Bitrix
	 */var p=Object.freeze({upload:"upload",wait:"wait",done:"done",error:"error"});var u=Object.freeze({image:"image",video:"video",audio:"audio",file:"file"});
/**
	 * Bitrix Messenger
	 * Message constants
	 *
...
/**
	 ...
	 * @subpackage im
	 * @copyright 2001-2020 Bitrix
	 */var b={chat:"chat",open:"open",user:"user",notification:"notification"};var I={item:"item",placeholder:"placeholder"};var D={general:"general",pinned:"pinned"};var h={received:"received",delivered:"delivered",error:"error"};var T=Object.freeze({confirm:1,simple:3,placeholder:5});e.DateFormat=i;e.DeviceType=t;e.DeviceOrientation=a;e.MutationType=s;e.StorageLimit=o;e.RestMethod=r;e.RestMethodHandler=l;e.EventType=n;e.DialogType=m;e.DialogCrmType=c;e.DialogReferenceClassName=g;e.DialogTemplateType=d;e.DialogState=M;e.FileStatus=p;e.FileType=u;e.MessageType=f;e.ChatTypes=b;e.TemplateTypes=I;e.RecentSection=D;e.MessageStatus=h;e.NotificationTypesCodes=T})(this.BX.Messenger.Const=this.BX.Messenger.Const||{});
