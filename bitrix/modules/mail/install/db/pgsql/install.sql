...
CREATE INDEX IX_B_MAIL_ACCESS_PERMISSION_ROLE_ID ON b_mail_access_permission (ROLE_ID);
CREATE INDEX IX_B_MAIL_ACCESS_PERMISSION_PERMISSION_ID ON b_mail_access_permission (PERMISSION_ID);
...
CREATE INDEX IX_B_HR_ACCESS_ROLE_RELATION_ROLE_ID ON b_mail_access_role_relation (ROLE_ID);
CREATE INDEX IX_B_HR_ACCESS_ROLE_RELATION_RELATION ON b_mail_access_role_relation (RELATION);
...
CREATE INDEX IXF_B_MAIL_MAILBOX_LIST_INDEX_SEARCH_INDEX ON b_mail_mailbox_list_search_index USING GIN (to_tsvector('english', SEARCH_INDEX));
