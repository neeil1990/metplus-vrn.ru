...
/*ZDUyZmZMDEwZTUwMDczYTRlMjE5ZWI5NDdmMjJjYmUxZjM3MDY=*/$GLOBALS['____340091887']= array(base64_decode(''.'ZGV'.'ma'.'W5l'));if(!function_exists(__NAMESPACE__.'\\___983285683')){function ___983285683($_905324023){static $_2015409276= false; if($_2015409276 == false) $_2015409276=array('RU5DT0R'.'F','WQ'.'='.'=');return base64_decode($_2015409276[$_905324023]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1077289476){ return true;} public static function IsFeatureEditable($_1077289476){ return true;} public static function SetFeatureEnabled($_1077289476, $_1481322552= true){} public static function SaveFeaturesSettings($_963564252, $_1636349943){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_668188926){} public static function ModifyFeaturesSettings($_668188926, $_1577648430){} public static function IsFeatureInstalled($_1077289476){ return true;}} $GLOBALS['____340091887'][0](___983285683(0), ___983285683(1));/**/			//Do not remove this
